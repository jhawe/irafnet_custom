...
# --- MAIN function
"iRafNet" <-
  function(X,W,ntree,mtry,genes.name,threads=1) {
...
#    for (j in 1:p){ 
      ...
      # there seemed to be a bug: mtry and ntree have not been forwarded to internal method!
      rout<-irafnet_onetarget(x=x.sorted,y=as.double(y),importance=TRUE,mtry=mtry,ntree=ntree,
